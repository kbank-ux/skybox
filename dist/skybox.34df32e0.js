        ...
        for(let i = 0; i < this._marbles.length; i++){
            ...
            if (marble.y > this._stage.goalY) {
                ...
                if (this._isRunning && this._winners.length === this._winnerRank + 1) {
                    ...
                    if (this._autoRecording) this._generateCSV(); // 녹화가 켜져 있을 경우에만 CSV 생성
...
},{"./data/constants":"dKlb7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"LqJb0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"66ig1":"66ig1"}]},["3dtlh","gH3Lb"], "gH3Lb", "parcelRequire967f", {})

//# sourceMappingURL=skybox.34df32e0.js.map
